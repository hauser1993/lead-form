...
const translations: Translations = {
  ...
  'step.assets': { en: 'Asset Info', de: 'Vermögensdaten' },
  ...
  'toast.workingOffline': { en: 'Working offline - changes will be saved when connection is restored', de: 'Offline-Modus - Ihre Änderungen werden automatisch synchronisiert' },
  'toast.applicationStarted': { en: 'Application started successfully!', de: 'Registrierung erfolgreich gestartet!' },
  'toast.personalInfoUpdated': { en: 'Personal information updated!', de: 'Persönliche Daten wurden aktualisiert!' },
  'toast.addressInfoUpdated': { en: 'Address information updated!', de: 'Adressdaten wurden aktualisiert!' },
  'toast.assetInfoUpdated': { en: 'Asset information updated!', de: 'Vermögensdaten wurden aktualisiert!' },
  ...
  'toast.networkError': { en: 'Network error. Please check your connection.', de: 'Netzwerkfehler. Bitte überprüfen Sie Ihre Internetverbindung.' },
  'toast.error': { en: 'An error occurred', de: 'Ein Fehler ist aufgetreten' },
  'toast.dataCleared': { en: 'All data cleared - starting fresh!', de: 'Alle Daten wurden gelöscht - Neustart!' },
  ...
  'welcome.description': { en: 'Thank you for your interest in investing with us. This quick onboarding process will collect the necessary information to get your investment account set up.', de: 'Vielen Dank für Ihr Interesse an einer Investition bei uns. Diese kurze Registrierung sammelt alle notwendigen Informationen für die Einrichtung Ihres Investmentkontos.' },
  'welcome.feature.investment.title': { en: 'Investment Opportunities', de: 'Investmentmöglichkeiten' },
  ...
  'welcome.feature.security.description': { en: 'Bank-level security with full regulatory compliance', de: 'Sicherheit auf Bankniveau mit vollständiger Einhaltung aller Vorschriften' },
  'welcome.feature.portfolio.title': { en: 'Portfolio Growth', de: 'Portfolio-Wachstum' },
  'welcome.feature.portfolio.description': { en: 'Diversify your portfolio with our curated investments', de: 'Diversifizieren Sie Ihr Portfolio mit unseren sorgfältig ausgewählten Investments' },
  ...
  'welcome.securityNotice': { en: 'Your information is encrypted and protected according to financial industry standards.', de: 'Ihre Daten sind verschlüsselt und werden gemäß den Standards der Finanzbranche geschützt.' },
  'welcome.needNotice': { en: 'What You\'ll Need:', de: 'Das benötigen Sie:' },
  'welcome.needDescription': { en: 'Personal information, address details, and identification for verification purposes.', de: 'Persönliche Daten, Adressinformationen und Identifikationsunterlagen für die Verifizierung.' },
  'welcome.getStarted': { en: 'Get Started', de: 'Jetzt beginnen' },

  // Personal Info Step
  'personal.title': { en: 'Personal Information', de: 'Persönliche Informationen' },
  'personal.subtitle': { en: 'Please provide your basic personal details', de: 'Bitte geben Sie Ihre persönlichen Daten ein' },
  'personal.gender': { en: 'Gender', de: 'Geschlecht' },
  'personal.gender.placeholder': { en: 'Select your gender', de: 'Geschlecht auswählen' },
  ...
  'personal.nationality.placeholder': { en: 'Select your nationality', de: 'Staatsangehörigkeit auswählen' },
  ...
  'personal.privacyDescription': { en: 'Your personal information is securely encrypted and will only be used for account verification and investment processing purposes.', de: 'Ihre persönlichen Daten sind sicher verschlüsselt und werden ausschließlich zur Kontoverifizierung und Investmentabwicklung verwendet.' },
  ...
  'address.line1': { en: 'Address Line 1', de: 'Straße und Hausnummer' },
  'address.line1.placeholder': { en: 'Enter your street address', de: 'Straße und Hausnummer eingeben' },
  ...
  'address.country.placeholder': { en: 'Select your country', de: 'Land auswählen' },
  'address.optional': { en: '(Optional)', de: '(Optional)' },
  'address.verificationNotice': { en: 'Address Verification:', de: 'Adressverifizierung:' },
  'address.verificationDescription': { en: 'This address will be used for identity verification and compliance purposes. Please ensure all details are accurate.', de: 'Diese Adresse wird zur Identitätsprüfung und für regulatorische Zwecke verwendet. Bitte stellen Sie sicher, dass alle Angaben korrekt sind.' },
  ...
  'assets.noTransactions': { en: 'No Transactions Added', de: 'Noch keine Transaktionen hinzugefügt' },
  'assets.noTransactionsDescription': { en: 'Add your first investment transaction to get started', de: 'Fügen Sie Ihre erste Investmenttransaktion hinzu' },
  ...
  'assets.notes.placeholder': { en: 'Add any additional notes about this transaction...', de: 'Zusätzliche Anmerkungen zu dieser Transaktion...' },
  ...
  'assets.investmentDescription': { en: 'Please provide accurate transaction details for proper portfolio assessment and compliance verification.', de: 'Bitte geben Sie genaue Transaktionsdetails für eine ordnungsgemäße Portfoliobewertung und Compliance-Prüfung an.' },
  'assets.fileUploadNotice': { en: 'File Upload:', de: 'Datei-Upload:' },
  'assets.fileUploadDescription': { en: 'Proof documents are securely uploaded to the server and permanently stored. You can view uploaded files using the "View file" link that appears after successful upload.', de: 'Nachweis-Dokumente werden sicher auf den Server hochgeladen und dauerhaft gespeichert. Sie können hochgeladene Dateien über den "Anzeigen"-Link einsehen, der nach erfolgreichem Upload erscheint.' },
  ...
  'legal.termsTitle': { en: 'Terms of Service', de: 'Allgemeine Geschäftsbedingungen' },
  'legal.termsAccept': { en: 'I have read and accept the Terms of Service', de: 'Ich habe die AGB gelesen und akzeptiere sie' },
  'legal.fullTerms': { en: 'Full Terms', de: 'Vollständige AGB' },
  'legal.privacyTitle': { en: 'Privacy Policy', de: 'Datenschutzerklärung' },
  'legal.privacyAccept': { en: 'I have read and accept the Privacy Policy', de: 'Ich habe die Datenschutzerklärung gelesen und akzeptiere sie' },
  'legal.fullPolicy': { en: 'Full Policy', de: 'Vollständige Datenschutzerklärung' },
  'legal.marketingTitle': { en: 'Marketing Communications', de: 'Marketing-Kommunikation' },
  'legal.marketingDescription': { en: 'Stay informed about new investment opportunities, market insights, and platform updates.', de: 'Bleiben Sie über neue Investmentmöglichkeiten, Markteinblicke und Plattform-Updates informiert.' },
  ...
  'legal.marketingUnsubscribe': { en: 'You can unsubscribe at any time. This does not affect important account notifications.', de: 'Sie können sich jederzeit abmelden. Dies betrifft nicht wichtige Konto-Benachrichtigungen.' },
  'legal.notice': { en: 'Legal Notice:', de: 'Rechtlicher Hinweis:' },
  'legal.noticeDescription': { en: 'These agreements are legally binding. Please review them carefully. Contact our legal team if you have any questions before proceeding.', de: 'Diese Vereinbarungen sind rechtlich bindend. Bitte lesen Sie sie sorgfältig durch. Kontaktieren Sie unser Rechtsteam bei Fragen, bevor Sie fortfahren.' },

  // Terms of Service content
  'terms.acceptance': { en: 'Acceptance of Terms', de: 'Annahme der Bedingungen' },
  'terms.acceptanceText': { en: 'By using our investment platform, you agree to be bound by these Terms of Service and all applicable laws and regulations.', de: 'Durch die Nutzung unserer Investment-Plattform stimmen Sie diesen Allgemeinen Geschäftsbedingungen und allen geltenden Gesetzen und Vorschriften zu.' },
  'terms.risks': { en: 'Investment Risks', de: 'Investmentrisiken' },
  'terms.risksText': { en: 'All investments carry risk of loss. Past performance does not guarantee future results. You should carefully consider your investment objectives and risk tolerance.', de: 'Alle Investments bergen Verlustrisiken. Vergangene Performance ist keine Garantie für zukünftige Ergebnisse. Sie sollten Ihre Investmentziele und Risikobereitschaft sorgfältig abwägen.' },
  'terms.eligibility': { en: 'Eligibility', de: 'Berechtigung' },
  'terms.eligibilityText': { en: 'You must be at least 18 years old and legally capable of entering into binding agreements to use our services.', de: 'Sie müssen mindestens 18 Jahre alt und rechtlich geschäftsfähig sein, um unsere Dienste zu nutzen.' },
  'terms.responsibilities': { en: 'Account Responsibilities', de: 'Konto-Verantwortlichkeiten' },
  'terms.responsibilitiesText': { en: 'You are responsible for maintaining the confidentiality of your account credentials and for all activities under your account.', de: 'Sie sind verantwortlich für die Vertraulichkeit Ihrer Zugangsdaten und alle Aktivitäten unter Ihrem Konto.' },
  ...
  'terms.liabilityText': { en: 'Our liability is limited to the maximum extent permitted by law. We are not liable for market losses or investment performance.', de: 'Unsere Haftung ist auf das gesetzlich zulässige Maximum beschränkt. Wir haften nicht für Marktverluste oder Investment-Performance.' },

  // Privacy Policy content
  'privacy.collection': { en: 'Information Collection', de: 'Datenerfassung' },
  'privacy.collectionText': { en: 'We collect personal information necessary for account verification, compliance, and service provision including name, address, financial information, and identification documents.', de: 'Wir erfassen persönliche Daten, die für Kontoverifizierung, Compliance und Diensterbringung notwendig sind, einschließlich Name, Adresse, Finanzinformationen und Ausweisdokumente.' },
  'privacy.usage': { en: 'Data Usage', de: 'Datennutzung' },
  'privacy.usageText': { en: 'Your information is used for account management, regulatory compliance, fraud prevention, and to provide investment services.', de: 'Ihre Daten werden für Kontoverwaltung, regulatorische Compliance, Betrugsprävention und zur Bereitstellung von Investment-Services verwendet.' },
  'privacy.protection': { en: 'Data Protection', de: 'Datenschutz' },
  'privacy.protectionText': { en: 'We employ industry-standard security measures including encryption, secure servers, and access controls to protect your personal information.', de: 'Wir verwenden branchenübliche Sicherheitsmaßnahmen einschließlich Verschlüsselung, sichere Server und Zugangskontrollen zum Schutz Ihrer persönlichen Daten.' },
  'privacy.sharing': { en: 'Information Sharing', de: 'Datenweitergabe' },
  'privacy.sharingText': { en: 'We may share information with regulatory authorities, service providers, and as required by law. We do not sell personal information to third parties.', de: 'Wir können Daten an Aufsichtsbehörden, Dienstleister und wie gesetzlich vorgeschrieben weitergeben. Wir verkaufen keine persönlichen Daten an Dritte.' },
  'privacy.retention': { en: 'Data Retention', de: 'Datenaufbewahrung' },
  'privacy.retentionText': { en: 'We retain your information as required by law and for legitimate business purposes. You may request data deletion subject to regulatory requirements.', de: 'Wir bewahren Ihre Daten wie gesetzlich vorgeschrieben und für legitime Geschäftszwecke auf. Sie können die Löschung Ihrer Daten beantragen, vorbehaltlich regulatorischer Anforderungen.' },
  'privacy.rights': { en: 'Your Rights', de: 'Ihre Rechte' },
  'privacy.rightsText': { en: 'You have the right to access, correct, and request deletion of your personal information, subject to regulatory constraints.', de: 'Sie haben das Recht auf Zugang, Berichtigung und Löschung Ihrer persönlichen Daten, vorbehaltlich regulatorischer Beschränkungen.' },
  ...
  'confirmation.privacyAccepted': { en: 'Privacy Policy accepted', de: 'Datenschutzerklärung akzeptiert' },
